    ...
    const platforms = [
        {
            ...
            icon: (
                <svg className="w-8 h-8 fill-current text-white" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier">
                ...
                <div className="container mx-auto px-4 relative z-10">
                    ...
                    {filteredPodcasts.length === 0 && (
                        <div className="flex flex-col items-center justify-center py-16 text-center">
                            ...
                            <h3 className="text-xl font-medium mb-2">Podcast Bulunamadı</h3>
                        </div>
                    )}
                </div>
            </div>
                    ...
                    <div className="rounded-2xl overflow-hidden bg-gradient-to-r from-yellow-500/20 to-black/70 backdrop-blur-md p-12 md:p-16">
                        <div className="max-w-4xl mx-auto text-center">
                            ...
                            <h2 className="text-3xl md:text-5xl font-bold mb-2">
                                Bizi <span className='text-yellow-500'>favori</span> platformunuzda takip edin<span className="text-yellow-500">.</span>
                            </h2>
